...
# Then we will create a dictionary of dictionaries for our categories. # This might seem a little bit confusing, but it allows us to iterate # through each data structure, and add the data to our models.
    ...
    python_pages = [
            ...
            'url':'http://www.greenteapress.com/thinkpython/',"views":72},
            {'title':'Learn Python in 10 Minutes',
            'url':'http://www.korokithakis.net/tutorials/python/',"views":71} ]
    django_pages = [
    ...
    other_pages = [
            ...
            {'title':'Flask',
            'url':'http://flask.pocoo.org',"views":39} ]
    # change number of like and view
